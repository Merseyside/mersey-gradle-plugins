...
package gradle.kotlin.dsl.plugins._ea817108c5fccbb4dbe1da73b6780d32
...
/**
 * The `dev.icerock` plugin group.
 */
@org.gradle.api.Generated
internal
class `DevIcerockPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `dev.icerock`.
 */
internal
val `DevPluginGroup`.`icerock`: `DevIcerockPluginGroup`
    get() = `DevIcerockPluginGroup`(plugins)


/**
 * The `dev.icerock.mobile` plugin group.
 */
@org.gradle.api.Generated
internal
class `DevIcerockMobilePluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `dev.icerock.mobile`.
 */
internal
val `DevIcerockPluginGroup`.`mobile`: `DevIcerockMobilePluginGroup`
    get() = `DevIcerockMobilePluginGroup`(plugins)


/**
 * The `dev.icerock.mobile.multiplatform` plugin implemented by [dev.icerock.gradle.MobileMultiPlatformPlugin].
 */
internal
val `DevIcerockMobilePluginGroup`.`multiplatform`: PluginDependencySpec
    get() = plugins.id("dev.icerock.mobile.multiplatform")
